...
public class BillDTO {
    ...
    private String otherUser; // Nombre del otro usuario (deudor o acreedor)
    ...
    public BillDTO(int id, String otherUser, String description, double amount, LocalDate dueDate) {
        this.id = id;
